...
export default function Home() {
  ...
  const getPlayStoreUrl = () => {
    ...
    if (lang === 'pt-PT') {
      return "https://play.google.com/store/apps/details?id=com.pintandoapalavra.app&referrer=utm_source%3Dfacebook%26utm_medium%3Dads%26utm_campaign%3Dfb_pt";
    } else if (lang.startsWith('pt')) {
      return "https://play.google.com/store/apps/details?id=com.pintandoapalavra.app&referrer=utm_source%3Dfacebook%26utm_medium%3Dads%26utm_campaign%3Dfb_br";
    } else if (lang.startsWith('es')) {
      return "https://play.google.com/store/apps/details?id=com.pintandoapalavra.app&referrer=utm_source%3Dfacebook%26utm_medium%3Dads%26utm_campaign%3Dfb_global_es";
    } else {
      return "https://play.google.com/store/apps/details?id=com.pintandoapalavra.app&referrer=utm_source%3Dfacebook%26utm_medium%3Dads%26utm_campaign%3Dfb_global_en";
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-900 transform-gpu">
      {/* Navigation */}
      ...
      <section className="pt-32 pb-20 lg:pt-40 lg:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <motion.a 
                ...
                animate={{ 
                  scale: [1, 1.02, 1],
                  boxShadow: [
                    "0px 0px 0px 0px rgba(79, 70, 229, 0.6)", 
                    "0px 0px 20px 15px rgba(79, 70, 229, 0)"
                  ]
                }}
                transition={{
                  duration: 2,
                ...
                className="flex items-center justify-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-slate-800 transition-colors shadow-lg transform-gpu will-change-transform"
              >
          ...
          >
            ...
            <img 
              src={APP_ICON_URL} 
              alt={`Interface do App ${t('app_name')}`} 
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href={playStoreUrl} target="_blank" rel="noopener noreferrer" onClick={handleDownloadClick} className="hover:text-white transition-colors">{t('nav.download')}</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-800 flex flex-col items-center gap-4 text-sm text-center">
            <p>&copy; 2026 {t('app_name')}<br />{t('footer.rights')}</p>
          </div>
        </div>
      </footer>
    </div>
