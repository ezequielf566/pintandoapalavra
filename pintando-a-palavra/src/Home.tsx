          ...
          >
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-slate-900">Criativo</span>
              </div>
              <p className="text-xs text-slate-500">Pintura digital para pequenos artistas</p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-slate-900">Divertido</span>
              </div>
              <p className="text-xs text-slate-500">Minijogos bíblicos educativos</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
