...
const resources = {
  ...
  'pt-PT': {
    translation: {
      ...
      hero: {
        badge: "Educação Cristã & Diversão",
        title: "A Bíblia ganha vida através da arte e do brincar",
        subtitle: "Uma aplicação segura e educativa projetada para ajudar as crianças a descobrir as histórias bíblicas de forma interativa e criativa.",
        cta_download: "Descarregar no Google Play",
        cta_learn: "Conhecer Recursos",
        badge_creative_title: "Criativo",
        badge_creative_desc: "Pintura digital para pequenos artistas",
        badge_fun_title: "Divertido",
      ...
      features: {
        title: "Tudo o que o seu filho precisa para aprender brincando",
        subtitle: "Recursos pensados para estimular a criatividade e o conhecimento bíblico.",
        items: {
          games: {
            title: "Minijogos Bíblicos",
      ...
      safety: {
        ...
        no_ads_desc: "Publicidade restrita e adequada para a faixa etária, seguindo as normas do Google Play.",
        privacy: "Privacidade Total",
        privacy_desc: "Não recolhemos dados pessoais. O ambiente é 100% focado na experiência da criança.",
        offline: "Acesso Offline",
        offline_desc: "Muitos recursos funcionam sem internet, garantindo segurança em qualquer lugar."
      },
      about: {
        ...
        p1: "O Pintando a Palavra nasceu do desejo de unir tecnologia e fé, oferecendo uma alternativa saudável de entretenimento para a nova geração.",
        p2: "Acreditamos que a arte é uma das formas mais poderosas de fixar a aprendizagem. Por isso, criamos um espaço onde a criança não apenas consome conteúdo, mas interage e cria a partir das verdades bíblicas.",
        stats: {
          users: "Crianças Impactadas",
          rating: "Avaliação Média",
          content: "Atividades Disponíveis"
      ...
      footer: {
        desc: "Ajudando as crianças a descobrir a Bíblia através da tecnologia, arte e brincadeira.",
      ...
      generosity: {
        title: "Generosidade",
        subtitle: "Pratique a Generosidade",
        desc: "Se desejar, conheça algumas plataformas onde é possível apoiar causas ao redor do mundo.",
        platforms: "Plataformas Conhecidas",
        visit: "Visitar site oficial",
        disclaimer: "Esta aplicação não possui vínculo ou parceria com as plataformas mencionadas. Os links levam para sites externos."
      },
      privacy_policy: {
        title: "Política de Privacidade",
        back: "Voltar para o Início",
        last_update: "Última atualização",
        intro_title: "1. Introdução",
        intro_p: "Agradecemos por escolher a aplicação Pintando a Palavra. Levamos a sua privacidade e a segurança dos dados dos seus filhos muito a sério.",
        data_title: "2. Recolha de Dados e Privacidade Infantil",
        data_p1: "O Pintando a Palavra é projetado para famílias e crianças (faixa etária de 9 a 12 anos e classificação livre).",
        data_p2: "Não recolhemos intencionalmente informações pessoais identificáveis (como nome, morada, e-mail ou número de telefone) de crianças.",
        data_p3: "A aplicação não solicita registo, login, nem acesso a dados sensíveis do dispositivo para o seu funcionamento.",
        ads_title: "3. Publicidade (Google AdMob)",
        ads_p: "Utilizamos o serviço Google AdMob para exibir anúncios, permitindo que a aplicação permaneça gratuita. Para garantir a segurança das crianças, configuramos os anúncios para estarem em conformidade com as Políticas do Google Play para Famílias.",
        ads_item1: "Apenas anúncios apropriados para a classificação etária da aplicação são exibidos.",
        ads_item2: "Utilizamos SDKs de publicidade que estão em conformidade com as políticas de proteção à criança (como a COPPA nos EUA e a RGPD na Europa).",
        ads_item3: "Não utilizamos publicidade baseada em comportamento (rastreamento) para utilizadores identificados como crianças.",
        perms_title: "4. Permissões do Dispositivo",
        perms_p: "A aplicação pode solicitar permissões básicas de funcionamento, como acesso à internet. Não acedemos à câmara, microfone, localização ou contactos.",
        share_title: "5. Partilha de Dados",
        share_p: "Não vendemos, trocamos ou transferimos informações pessoais para terceiros.",
        global_title: "6. Conformidade Global (RGPD, CCPA, LGPD)",
        global_p: "Como uma aplicação global disponível em múltiplos idiomas (português, inglês e espanhol), estamos comprometidos com as principais regulamentações de privacidade do mundo:",
      ...
      terms: {
        ...
        last_update: "Última atualização",
        section1_title: "1. Aceitação dos Termos",
        section1_p: "Ao aceder e usar a aplicação Pintando a Palavra, concorda em cumprir e estar vinculado aos seguintes Termos de Uso.",
        section2_title: "2. Descrição do Serviço",
        section2_p: "O Pintando a Palavra é uma plataforma educativa cristã que oferece minijogos, ferramentas de pintura digital e materiais para impressão (PDF).",
        section3_title: "3. Uso Adequado",
        section3_p: "A aplicação é destinada ao uso pessoal e não comercial por famílias, educadores e ministérios infantis.",
        section4_title: "4. Propriedade Intelectual",
        section4_p1: "Os materiais em formato PDF disponibilizados na aplicação são considerados open source e de uso livre para fins educativos.",
        section4_p2: "No entanto, as artes em formato SVG e demais elementos visuais da interface são de propriedade exclusiva do Pintando a Palavra.",
        section5_title: "5. Links para Terceiros",
        section5_p: "A aplicação pode conter links para sites ou serviços de terceiros. Não temos controlo sobre o conteúdo desses sites.",
        section6_title: "6. Limitação de Responsabilidade",
        section6_p: "A aplicação é fornecida 'como está', sem garantias de qualquer tipo.",
        section7_title: "7. Alterações nos Termos",
        section7_p: "Reservamo-nos o direito de modificar estes Termos de Uso a qualquer momento.",
  ...
  en: {
    translation: {
      ...
      about: {
        title: "Our Mission",
        p1: "Painting the Word was born from the desire to unite technology and faith, offering a healthy entertainment alternative for the new generation.",
      ...
      privacy_policy: {
        ...
        intro_p: "Thank you for choosing the Painting the Word app. We take your privacy and the security of your children's data very seriously.",
        data_title: "2. Data Collection and Child Privacy",
        data_p1: "Painting the Word is designed for families and children (age group 9 to 12 and free classification).",
      ...
      terms: {
        ...
        section1_p: "By accessing and using the Painting the Word app, you agree to comply with and be bound by the following Terms of Use.",
        section2_title: "2. Service Description",
        section2_p: "Painting the Word is a Christian educational platform that offers mini-games, digital painting tools, and printable materials (PDF).",
        ...
        section4_p2: "However, SVG arts and other visual elements of the interface are the exclusive property of Painting the Word.",
  ...
  es: {
    translation: {
      app_name: "Coloreando la palabra",
      nav: {
        features: "Recursos",
        safety: "Seguridad",
        about: "Acerca de",
      ...
      about: {
        ...
        p1: "Coloreando la palabra nació del deseo de unir tecnología y fe, ofreciendo una alternativa saludable de entretenimiento para la nueva generación.",
      ...
      privacy_policy: {
        ...
        intro_p: "Gracias por elegir la aplicación Coloreando la palabra. Nos tomamos muy en serio su privacidad y la seguridad de los datos de sus hijos.",
        data_title: "2. Recopilación de Datos y Privacidad Infantil",
        data_p1: "Coloreando la palabra está diseñado para familias y niños (rango de edad de 9 a 12 años y clasificación libre).",
      ...
      terms: {
        ...
        section1_p: "Al acceder y utilizar la aplicación Coloreando la palabra, usted acepta cumplir y estar sujeto a los siguientes Términos de Uso.",
        section2_title: "2. Descripción del Servicio",
        section2_p: "Coloreando la palabra es una plataforma educativa cristiana que ofrece minijuegos, herramientas de pintura digital y materiales para imprimir (PDF).",
        ...
        section4_p2: "Sin embargo, las artes en formato SVG y otros elementos visuales de la interfaz son propiedad exclusiva de Coloreando la palabra.",
